...
export default function ConfirmationMessage({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "absolute inset-0 -z-10 h-full w-full items-center bg-transparent",
          backgroundClassName,
        )}
      />
      ...
      <div className="flex h-64 max-w-lg flex-col items-center justify-center">
        ...
        >
          {/* Message box */}
          <div className="my-4 flex h-fit w-full rounded-lg bg-white/30 bg-opacity-90 p-6 py-4 backdrop-blur-md">
            <div className="mr-4 flex h-12 min-w-12 items-center justify-center rounded-full bg-green-800 text-white">
              {labelName[0]}
            </div>
            <div className="text-gray-800">
              <p className="text-xl font-bold text-black">{labelName}</p>
              <motion.p
