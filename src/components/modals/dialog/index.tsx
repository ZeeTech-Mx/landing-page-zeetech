      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className='fixed inset-0 z-[60] top-0 left-0 right-0 bottom-0 flex flex-col items-center w-full h-screen justify-center dark:bg-black/5 bg-white/5 backdrop-blur-md cursor-zoom-out border'
